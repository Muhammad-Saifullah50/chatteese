...
const ConversationList = ({ initalItems, users }: ConversationListProps) => {
  const [items, setItems] = useState<FullConversationType[]>(initalItems)
      ...
      <div className='px-5'>
        <div className='flex justify-between mb-4 pt-4'>
          ...
          <div
            ...
            className='rounded-full p-2 bg-gray-100 text-gray-600 cursor-pointer opacity-75 transition'>
